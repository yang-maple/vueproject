<template >
  <el-table :data="tableData" :default-sort="{ prop: 'date', order: 'descending' }" style="width: 100%" stripe
    @cell-click="handle">
    ...
    <el-table-column label="标签" width="350">
      <template #default="scope">
        <el-tag class="ml-2" type="success" v-for="(v, k) in scope.row.metadata.labels " :key="k">{{ k }}:{{ v
        }}<br></el-tag>
      </template>
    </el-table-column>
